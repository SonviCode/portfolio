...
export default function Home() {
  ...
  return (
    <>
      ...
      ></div>
      <section id="accueil" className="max-w-7xl mx-auto" ref={homeRef}>
        <div className="flex flex-col pt-32 md:pt-0 px-[10%] justify-around items-center md:h-screen min-h-[700px] gap-12 md:flex-row">
